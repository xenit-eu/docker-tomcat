...
setJavaOption 'TOMCAT_RELAXED_PATH_CHARS' '-DTOMCAT_RELAXED_PATH_CHARS='${TOMCAT_RELAXED_PATH_CHARS:-''}
setJavaOption 'TOMCAT_APPLICATIONLOG_MAXDAYS' '-DTOMCAT_APPLICATIONLOG_MAXDAYS='${TOMCAT_APPLICATIONLOG_MAXDAYS:-'5'}
